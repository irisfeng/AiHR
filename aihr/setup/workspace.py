...
def _workspace_links() -> list[dict]:
    return [
        ...
        {"type": "Link", "label": "Job Offer", "link_type": "DocType", "link_to": "Job Offer"},
        ...
        {"type": "Link", "label": "Employee Onboarding", "link_type": "DocType", "link_to": "Employee Onboarding"},
        {"type": "Link", "label": "Employee", "link_type": "DocType", "link_to": "Employee"},
        {"type": "Link", "label": "Department", "link_type": "DocType", "link_to": "Department"},
